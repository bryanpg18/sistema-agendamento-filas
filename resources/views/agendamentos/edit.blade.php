...
@section('conteudo')
    ...
    <div class="max-w-2xl mx-auto"
        ...
        <div class="mb-6">
            ...
            <h1 class="text-2xl font-bold text-gray-800 mt-1">Editar Agendamento</h1>
        </div>
            ...
            <form method="POST" action="{{ route('agendamentos.update', $agendamento) }}" class="space-y-4">
                ...
                <div>
                    ...
                    <textarea name="observacoes" rows="3"
                              class="w-full border border-gray-200 rounded-lg px-3 py-2 text-sm focus:outline-none focus:ring-2 focus:ring-teal-700"
                              placeholder="Informações adicionais (opcional)">{{ old('observacoes', $agendamento->observacoes) }}</textarea>
