            ...
            <div class="w-full max-w-4xl bg-white dark:bg-slate-900 border border-slate-200/80 dark:border-slate-800 rounded-2xl shadow-xl overflow-hidden flex flex-col md:flex-row transition-colors">
                ...
                <div class="w-full md:w-1/2 p-8 md:p-10 flex flex-col justify-center">
                    <div class="flex items-center justify-between mb-1">
                        <h2 class="text-2xl font-bold text-slate-900 dark:text-white">Criar conta</h2>
                        <button type="button"
                                x-data="{
                    ...
                    <p class="text-slate-500 dark:text-slate-400 mb-6 text-sm">Preencha os dados para começar</p>
                    ...
                    <form method="POST" action="{{ route('register') }}" class="space-y-4">
                        ...
                        <div>
                            <label for="password_confirmation" class="block text-sm font-medium text-slate-700 dark:text-slate-300 mb-1">Confirmar Senha</label>
